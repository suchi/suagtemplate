...
1. Run the checks defined in `.claude/commands/consistency-check.md`, then fix findings (doc-side errors in the docs, code-side errors in the code). Report what was fixed, or "consistency OK".
